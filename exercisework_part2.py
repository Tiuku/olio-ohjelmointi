...
class Pet(User):
    ...
    def __str__(self):
        return format(User.__str__(self)) + " Your pet's specie is: " + format(self.specie) + " and it is: " + format(self.race) + " Your " + format(self.specie) + " is " + format(self.age) + " years old and is called " + format(self.name)
